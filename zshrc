...
[[ $PROFILE ]] && echo -e "[32;1m[INFO][0m Profileing On" && zmodload zsh/zprof
export ZSH=$HOME/.sanguis_settings/oh-my-zsh
...
"
  ...
  do
    case $opt in
      ...
      * ) echo -e "[31;1m[ERROR][0m Option does not exist : $OPTARG
"
        echo "$_USAGE"; return 1   ;;
 ...
 [[ -z $1 ]] && echo $_USAGE && return 1
  ...
  git -C $DIRECTORY add $FILE
  git -C $DIRECTORY commit $FILE
  [[ $_RELOAD ]] && echo -e "[32;1m[INFO][0m Reloading .zshrc" && source $HOME/.zshrc
#  return 0
}
...
export TF_LOG=$LEVEL
export TF_LOG_PATH=/tmp/tf_debug.log
echo -e  "[32;1m[INFO][0m Terraform log level set to debug.  Log output at $TF_LOG_PATH"
}
alias tf-log-tail="tail -f $TF_LOG_PATH"
